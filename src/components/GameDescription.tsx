...
export default function GameDescription({Poster,Description,Name}:{Poster:string,Description:string,Name:string}) {
    return <>
    <motion.div initial={{opacity:0,y:200,scale:0.7}} whileInView={{opacity:1,y:0,scale:1,transition:{duration:1.2}}}  className='absolute duration-150 top-20 left-20 z-200'>
